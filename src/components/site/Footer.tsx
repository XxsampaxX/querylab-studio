...
export function Footer() {
  return (
    <footer className="relative border-t border-[color:var(--hairline)] bg-[color:var(--background-secondary)]">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-14 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div>
            <Logo size={32} />
            <p className="mt-6 max-w-sm text-[14px] leading-[1.8] text-muted-foreground">
            ...
            <a
              ...
              className="btn-primary mt-8 px-4 py-2.5 text-[13px]"
            >
            ...
            <ul className="mt-5 space-y-3 text-[14px]">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="text-foreground/90 transition-colors duration-200 hover:text-brand"
                >
                  {PHONE_DISPLAY}
                </a>
              </li>
        ...
        <div className="mt-20 flex flex-col items-start justify-between gap-3 border-t border-[color:var(--hairline)] pt-8 text-[12px] text-muted-foreground md:flex-row md:items-center">
