          ...
          <div className="space-y-3">
            {points.map((p, i) => (
              <motion.div
                ...
                className="group flex gap-5 rounded-3xl border-hairline bg-card/60 p-6 transition-all duration-300 hover:-translate-y-0.5 hover:border-foreground/15 hover:bg-card md:p-8"
              >
